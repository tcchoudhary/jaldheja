...
const Careers = () => {
  ...
  const handleChange = (e) => {
    ...
    // Function to validate file (only document types and size < 10MB)
    ...
    if (name === 'document') {
      ...
      if (files.length > 0) {
        ...
        if (file?.size > 10 * 1024 * 1024) {
          setErrors((prevErrors) => ({
            ...prevErrors,
            document: 'Please upload a file with size less than 10MB',
          }));
        } else if (!validateFile(file)) {
          setErrors((prevErrors) => ({
            ...prevErrors,
            document: 'Please upload a valid document file (PDF, DOC, DOCX).',
          }));
        } else {
          setErrors((prevErrors) => ({
            ...prevErrors,
          ...
          <div className="accordion">
            ...
            <div className={`panel ${openPanel === 1 ? "" : "closed"}`} key={1}>
              <div className="panel-header" onClick={() => togglePanel(1)}>
                ...
                <div className="arrowBtn">
                  <img src={anchorarrow} alt="anchorarrow" />
                </div>
              </div>
              <div
            ...
            <div className={`panel ${openPanel === 3 ? "" : "closed"}`} key={3}>
              ...
              <div
                className={`panel-content ${openPanel === 3 ? "panelOpen" : ""
                  }`}
