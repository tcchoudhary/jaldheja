...
const arrCircle = [
  {
    ...
    disc: "Jaladhija transforms public spaces with our smart sanitation solutions, improving hygiene and accessibility in urban areas. Our state-of-the-art public toilets ensure cleanliness and safety in high-traffic locations like parks, shopping malls, and transportation hubs.",
  },
  {
    id: 2,
    deg: 72,
    ...
    disc: "Enhance your guest experience with Jaladhija's smart public toilets. Whether it's tourist destinations or hotels, our innovative solutions provide hygienic, sustainable, and convenient facilities that meet the needs of travelers and visitors.",
  },
  {
    id: 3,
    deg: 144,
    ...
    disc: "Jaladhija partners with government bodies to improve public sanitation infrastructure. We provide cost-effective, eco-friendly, and automated toilet solutions for cities, ensuring a cleaner environment and enhanced public health for citizens.",
  },
  {
    id: 4,
    deg: 216,
  ...
  },
  {
    ...
    disc: "For large-scale events, festivals, and public gatherings, Jaladhija offers smart sanitation solutions that ensure cleanliness and comfort. Our modular, efficient toilet units are perfect for high-capacity venues, offering both convenience and sustainability.",
  },
  {
    id: 6,
    deg: 302,
  ...
  },
  {
    ...
    disc: "Jaladhija ensures premium sanitation experiences for commercial spaces like offices and malls. Our modern, automated public toilets are designed for efficiency and sustainability, offering a seamless and hygienic experience for employees and customers alike.",
  },
];
  ...
  return (
    <section className="services">
      <div className="circle--slider">
        <div
          className="rotate--circle count5"
          ...
          <ul className="circle--rotate">
            {circleArr.map((item, index) => (
              ...
              >
                <div
                  className="icon"
                  onClick={() => handleCircleClick(item, index)}
                >
        ...
        <div className="industrie_content">
          {circleArr.map((item, index) => (
            <div
              className={`ic__item ${index === activeIndex ? "active" : ""}`}
              key={index}
            >
              <h4>{item?.title}</h4>
              <p>{item?.disc}</p>
